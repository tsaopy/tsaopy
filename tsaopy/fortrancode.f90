...
subroutine deriv(x_in,a_in,b_in,c_in,result,na,nb,cn,cm,f_i)
    ...
    !--------------------------------------------------------
    !
    subroutine simulation(x_in,a_in,b_in,c_in,f_in,result,dt,datalen,na,nb,cn,cm,nf)
    implicit none
    ! inout vars
    ...
    !--------------------------------------------------------
    !
    subroutine simulationv(x_in,a_in,b_in,c_in,f_in,result,dt,datalen,na,nb,cn,cm,nf)
        implicit none
        ! inout vars
        integer,intent(in) :: na,nb,cn,cm,datalen,nf
        real(8),intent(in) :: dt
